...
export const setRecommendedUsers = (recommendedUsers) => ({ type: SET_RECOMMENDED_USERS, recommendedUsers })
export const setViewedProfileUsers = (viewedProfileUsers) => ({ type: SET_VIEWED_PROFILE_USERS, viewedProfileUsers })
